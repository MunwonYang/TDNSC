# This code obtains the "TDNSC" classification result on Model M1
rm(list = ls())
...
TDNSC_M1 <- foreach(j=1:R,.combine = rbind,
...
TDNSC_M1 <- as.data.frame(TDNSC_M1)
error <- as.numeric(TDNSC_M1$er)
print("M1 TDNSC")
