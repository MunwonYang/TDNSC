# This code obtains the "MSDA" classification result on Model T1
rm(list = ls())
...
MSDA_T1 <- foreach(j = 1:R,.combine = rbind,
...
MSDA_T1 <- as.data.frame(MSDA_T1)
error <- as.numeric(MSDA_T1$er)
print("T1 MSDA")
