# This code obtains the "TDNSC" classification result on Model T1
rm(list = ls())
...
TDNSC_T1 <- foreach(j=1:R,.combine = rbind,
...
TDNSC_T1 <- as.data.frame(TDNSC_T1)
error <- as.numeric(TDNSC_T1$er)
print("T1 TDNSC")
