# This code obtains the "MSDA" classification result on Model M2
rm(list = ls())
...
MSDA_M2 <- foreach(j = 1:R,.combine = rbind,
...
MSDA_M2 <- as.data.frame(MSDA_M2)
error <- as.numeric(MSDA_M2$er)
print("M2 MSDA")
