# This code obtains the "Bayes Error" result on Model M2
rm(list = ls())
...
Bayes_error_M2 <- foreach(j = 1:R,.combine = rbind,
...
Bayes_error_M2 <- as.data.frame(Bayes_error_M2)
error <- as.numeric(Bayes_error_M2$er)
print("M2 Bayaes Error")
