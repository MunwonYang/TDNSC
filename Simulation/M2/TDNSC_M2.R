# This code obtains the "TDNSC" classification result on Model M2
rm(list = ls())
...
TDNSC_M2 <- foreach(j = 1:R,.combine = rbind,
...
TDNSC_M2 <- as.data.frame(TDNSC_M2)
error <- as.numeric(TDNSC_M2$er)
print("M2 TDNSC")
