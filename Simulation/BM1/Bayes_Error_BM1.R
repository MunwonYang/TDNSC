# This code obtains the "Bayes Error" result on Model BM1
rm(list = ls())
...
Bayes_error_BM1 <- foreach(j = 1:R,.combine = rbind,
...
Bayes_error_BM1 <- as.data.frame(Bayes_error_BM1)
error <- as.numeric(Bayes_error_BM1$er)
print("BM1 Bayes Error")
