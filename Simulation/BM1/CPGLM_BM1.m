...
v1 = zeros(p1,p2);
v2 = zeros(p1,p2);
v1([1,2,11,12],[1,2]) = -0.1;
v1([1,2,11,12],[11,12]) = 1;
v2([1,2,11,12],[1,2]) = 0.1;
v2([1,2,11,12],[11,12]) = -1;
...
parfor (run = 1:Run,cluster)
    ...
    lambda=[0.001,0.005,0.01,0.1,0.3,0.5,1,2,5,7.5,10,15]; % Candidiate Lambda value
