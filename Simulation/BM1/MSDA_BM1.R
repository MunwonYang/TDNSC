# This code obtains the "MSDA" classification result on Model BM1
rm(list = ls())
...
MSDA_BM1 <- foreach(j = 1:R,.combine = rbind,
...
MSDA_BM1 <- as.data.frame(MSDA_BM1)
error <- as.numeric(MSDA_BM1$er)
print("BM1 MSDA")
