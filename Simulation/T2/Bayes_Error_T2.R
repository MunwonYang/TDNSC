# This code obtains the "Bayes Error" result on Model T2
rm(list = ls())
...
Bayes_error_T2<- foreach(j = 1:R,.combine = rbind,
...
Bayes_error_T2 <- as.data.frame(Bayes_error_T2)
error <- as.numeric(Bayes_error_T2$er)
print("T2 Bayes Error")
