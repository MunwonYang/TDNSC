# This code obtains the "NSC" classification result on Model BM2
rm(list = ls())
...
NSC_BM2 <- foreach(j=1:R,.combine = rbind,
...
NSC_BM2 <- as.data.frame(NSC_BM2)
error <- as.numeric(NSC_BM2$er)
print("BM2 NSC")
