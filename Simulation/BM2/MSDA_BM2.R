# This code obtains the "MSDA" classification result on Model BM2
rm(list = ls())
...
MSDA_BM2 <- foreach(j=1:R,.combine = rbind,
...
MSDA_BM2 <- as.data.frame(MSDA_BM2)
error <- as.numeric(MSDA_BM2$er)
print("BM2 MSDA")
