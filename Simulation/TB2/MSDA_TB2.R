# This code obtains the "MSDA" classification result on Model TB2
rm(list = ls())
...
MSDA_TB2 <- foreach(j = 1:R,.combine = rbind,
...
MSDA_TB2 <- as.data.frame(MSDA_TB2)
error <- as.numeric(MSDA_TB2$er)
print("TB2 MSDA")
