# This code obtains the "Bayes Error" result on Model TB2
rm(list = ls())
...
Bayes_error_TB2 <- foreach(j = 1:R,.combine = rbind,
...
Bayes_error_TB2 <- as.data.frame(Bayes_error_TB2)
error <- as.numeric(Bayes_error_TB2$er)
print("TB2 Bayes Error")
