# This code obtains the "NSC" classification result on Model TB2
rm(list = ls())
...
NSC_TB2 <- foreach(j = 1:R,.combine = rbind,
...
NSC_TB2 <- as.data.frame(NSC_TB2)
error <- as.numeric(NSC_TB2$er)
print("TB2 NSC")
