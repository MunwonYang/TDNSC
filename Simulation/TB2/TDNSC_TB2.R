# This code obtains the "TDNSC" classification result on Model TB2
rm(list = ls())
...
TDNSC_TB2 <- foreach(j=1:R,.combine = rbind,
...
TDNSC_TB2 <- as.data.frame(TDNSC_TB2)
error <- as.numeric(TDNSC_TB2$er)
print("TB2 TDNSC")
