# This code obtains the "TDNSC" classification result on Model TB1
rm(list = ls())
...
TDNSC_TB1 <- foreach(j = 1:R,.combine = rbind,
...
TDNSC_TB1 <- as.data.frame(TDNSC_TB1)
error <- as.numeric(TDNSC_TB1$er)
print("TB1 TDNSC")
