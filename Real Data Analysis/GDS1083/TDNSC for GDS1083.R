# This code obtains the "TDNSC" classification result on GDS1083(Multi-categorical classification problem)
rm(list = ls())
...
GDS1083_TDNSC <- foreach(j = 1:R,.combine = rbind,
...
GDS1083_TDNSC <- as.data.frame(GDS1083_TDNSC)
error <- as.numeric(GDS1083_TDNSC$er)
